...
app='/mnt/lustre/tursafs1/home/dp358/dp358/dc-mukh1/CPN/constant_deformations.py'
opt=('--N=3' '--i=0' '--j=0' '--pidx=0')

# run! #########################################################################
for deftype in 'HomogDef' 'TorusDef' 'ProjDef' 'SkewMatDef'; do
